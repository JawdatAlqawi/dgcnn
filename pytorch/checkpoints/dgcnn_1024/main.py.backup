    ...
    for epoch in range(args.epochs):
        ...
        for batch in train_loader:
            ...
            if count % (args.batch_size * 10) == 0:
                io.cprint('  epoch %d, batch %d, loss %.6f' % (epoch, int(count), loss.item()))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--use_sgd', action='store_true', default=True,
                        help='Use SGD (default: True, use --no_sgd to disable)')
    parser.add_argument('--no_sgd', action='store_true', default=False,
    ...
    args.use_sgd = args.use_sgd and not args.no_sgd
